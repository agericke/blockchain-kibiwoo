...
/// When running tests, Truffle will dpeloy a fresh instance of the contract being tested to the 
///  Blockchain.
...
contract TestKibiwooRegisterProducts {
    ...
    function testProductToStoreVar () public {
        ...
        Assert.equal(
            pnonOwner, 
            address(0), 
            "Owner of a non created product failed. Address should be 0x0."
        );
    }
    ...
    //  //Assert.equal(
    //      //owners[expectedProductId], 
    //      //expectedOwner, 
    //      //"Owner of the expected product should be this contract"
    //  //);
    // }
