...
/// @title A contract that extents Kibiwoo's contract registration functionality for managing 
...
contract KibiwooManageProducts is KibiwooRegisterProducts {
    ...
    function addComplement(uint _productId, uint _subcategory, string memory _name) 
        public 
        ...
        returns (uint) 
    {
        ...
        // TODO: Require that the uint that represents the category coincides with the number of 
        //  categories defined.
        // TODO: Require that address is not equal to zero address?
